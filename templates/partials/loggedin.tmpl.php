...
<?php if (User::can_access(User::U_TEACHER)) { ?><form id="searchform">
	<div><img src="images/search.png" class="right" /><input type='text' name='search' id="searchquerystring" onkeyup="lookup();" value="search..." autocomplete="off" class='presearch' /></div>
