...
class CompleteEvaluationSeleniumTest extends PHPUnit_Extensions_SeleniumTestCase {
	protected function setUp(){
		SCHelper::setUp($this, "fast");
	}
	
	public function testCompleteEvaluation(){	
		//login as professor	
		SCHelper::login($this);
		...
		$this->open("/evaluations");      
		SCHelper::waitForAjax($this);
		$this->click("xpath=//img[@alt='open-incomplete']");
		$this->waitForPageToLoad();
